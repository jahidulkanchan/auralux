  ...
  return (
    <>
      <section className="relative bg-dark">
        ...
        <div className="z-10 container px-3 py-10 mx-auto gap-5 flex min-h-screen flex-col-reverse items-center justify-between text-white lg:flex-row">
          <div className="left-content text-center lg:text-left max-w-3xl space-y-4">
            ...
            <div className="cta-btn uppercase mx-auto lg:mx-0 bg-light-dark w-fit px-5 py-3 md:py-4 rounded text-sm border border-transparent hover:border-light-orange cursor-pointer">Book Appointment</div>
          </div>
